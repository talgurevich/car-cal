...
export default function ScenarioForm({ onSubmit, defaultValues }: ScenarioFormProps) {
  const {
    ...
    defaultValues: {
      ...
      financeYears: defaultValues?.financeYears ?? undefined,
      apr: defaultValues?.apr ?? 0.05,
      annualKm: defaultValues?.annualKm ?? undefined,
      ...
      monthlyMaint: defaultValues?.monthlyMaint ?? undefined,
      monthlyInsurance: defaultValues?.monthlyInsurance ?? undefined,
